...
<body>
	...
	<div class="container bodytrim">
		<div class="row ">
			<div class="col-md-auto hidelargenav">
					    		...
					    		<div id="carouselExampleFade " class="carousel slide carousel-fade " data-ride="carousel">
			  						<div class="carousel-inner shadow-lg mb-5 bg-white rounded ">
				    					<div class="carousel-item active">
				      						<img src="fruitsandvegetables.jpg" class="d-block w-100" width="200" height="" alt="fruitsandvegetables.jpg">
				    					</div>
				    					<div class="carousel-item">
									     	<img src="meatandfish.jpg" class="d-block w-100" width="200" height="" alt="meatandfish.jpg">
									    </div>
				    					<div class="carousel-item">
									        <img src="spiceandgrains.jpeg" class="d-block w-100" width="200" height="" alt="spiceandgrains.jpeg">
									    </div>
			  						</div>
