			...
			<div class="row ">
				...
				<div class="col-sm-auto headerpadding">
					<form class="form-inline">
			    		<input class="form-control mr-sm-2" type="search" placeholder="Search" value="" aria-label="Search" onkeyup="showusers('notset','1','0','5',this.value); showorders('notset','1','0','5',this.value) ">
		 			</form>
				</div>
				<div class="col-sm-auto headerpadding ">
				    <button type="button" id="profilebutton"  onclick="viewadminprofilediv()" class="btn btn-success" >Logged in as <?php echo $user['first_name']?> </button>
				</div>
				<div class="col-sm-auto headerpadding ">
